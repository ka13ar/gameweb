...
if ($show_navigation == '1') $output .= '<div class="navslider" style="display:none"><span class="prev"><i class="fa fa-arrow-left"></i></span><span class="next"><i class="fa fa-arrow-right"></i></span></div>';
ob_start();
?>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		function handleTweets(tweets){
			...
			element.innerHTML = html;
			<?php endif; ?>
			jQuery('#sns_twitter_<?php echo $uq; ?> .user a img').each(function(){
		...
		var config = {
		  ...
		  "maxTweets": limit,
		  "enableLinks": true,
		  "showUser": <?php echo $show_avartar; ?>,
		  "showTime": <?php echo $show_date; ?>,
		  "dateFunction": '',
		  "showRetweet": false,
		  "customCallback": handleTweets,
		  "showInteraction": <?php echo $show_interact_link; ?>
		};
