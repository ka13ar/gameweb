...
if ( $brand->have_posts() ) :
	ob_start();
?>
	<div id="sns_ourbrand<?php echo $uq; ?>" class="<?php echo $class ?>">
		<?php if ( $title !='' ): ?>
		...
		<div class="ourbrand-content">
			...
			<ul class="clearfix">
				...
				<li>
					<?php if ( function_exists('rwmb_meta') && rwmb_meta('snsnova_link') ): ?>
					<a href="<?php echo esc_url( rwmb_meta('snsnova_brandlink') ); ?>" title="<?php echo esc_attr(get_the_title()); ?>" target="<?php echo esc_attr($link_target); ?>">
