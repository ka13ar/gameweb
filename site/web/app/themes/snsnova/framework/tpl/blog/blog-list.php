...
snsnova_pagetitle();
?>
<div class="blog-list posts<?php echo esc_attr($wclass);?>">
	<ul>
		<?php 
		...
		<li class="post-item" id="post-<?php the_ID() ?>">
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="inner-post">
					<div class="l-post format-<?php echo esc_attr(get_post_format()); ?>">
						<?php
						// Post Quote
					    ...
					    elseif ( get_post_format() == 'link' && function_exists('rwmb_meta') && rwmb_meta('snsnova_post_linkurl') ) : ?>
					        <div class="link-info post-thumb">
					            <a class="gfont" title="<?php echo esc_attr(rwmb_meta('snsnova_post_linktitle')) ?>" href="<?php echo esc_url( rwmb_meta('snsnova_post_linkurl') ) ?>"><?php echo esc_attr(rwmb_meta('snsnova_post_linktitle')) ?></a>
					        </div>
					    <?php
					    // Post Video
						...
						// Post default
							...
							<?php if ( has_post_thumbnail() ) : ?>
						        ...
						        <?php
						            the_post_thumbnail($snsnova_obj->snsnova_getOption('img_size'), array( 'width' => 350, 'height' => 200 ));
						        ?>
						        </div>
						    <?php endif; ?>
					    <?php endif;?>
					...
					<div class="r-post">
			            ...
			            <div class="content">
				            ...
				            <?php } else { ?>
				                ...
				                <?php if ($snsnova_obj->snsnova_getOption('enable_readmore') == '' || $snsnova_obj->snsnova_getOption('enable_readmore') == true) : ?>
