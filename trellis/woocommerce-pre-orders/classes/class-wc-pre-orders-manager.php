...
class WC_Pre_Orders_Manager {
	...
	public function __construct() {
		...
		add_action( 'wc_pre_orders_completion_check', array( $this, 'check_for_pre_orders_to_complete' ) );
	...
	public function check_for_pre_orders_to_complete() {
		...
		foreach ( $query->posts as $order_post ) {
			...
			$time_now_in_utc = new DateTime( 'now', new DateTimeZone( 'UTC' ) );
			$time_now_in_utc = $time_now_in_utc->format( 'U' );
