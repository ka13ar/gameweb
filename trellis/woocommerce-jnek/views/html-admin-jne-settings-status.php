...
<table class="woocommerce_jne_status_table widefat is-large-screen" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            <td>
				<?php echo __( 'Data Kota', 'agenwebsite' );?>
                <?php echo WC_JNE()->help_tip( 'Data kota yang sudah diupload dan digunakan.', 'right' );?>
            </td>
            <td><?php echo ( WC_JNE()->datakota_is_uploaded() ) ? '<mark class="yes">' . WC_JNE()->get_nama_datakota() . '</mark>' : '<mark class="no">' . __( 'Belum Upload', 'agenwebsite' ) . '</mark>'?></td>
            <td>
            </td>
        </tr>
        <tr>
